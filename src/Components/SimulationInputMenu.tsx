...
const SimulationInputMenu = (props: { onSubmitText(text: string): void } ) => {
  ...
  return (
    <div className={css.simulation_menu_container} style={{ position: active ? 'fixed' : 'unset' }}>
      <div className={css.simulation_menu + (active ? '' : ' hidden')}>
        <div className={css.simulation_menu_title_container}>
          <div className={css.simulation_menu_title}>
            SIMULATION OPTIONS
          </div>
          <i onClick={toggleActive} className={css.simulation_close_icon + ` fa fa-chevron-${active ? 'down' : 'up'}`} />
        </div>
...
export default SimulationInputMenu